...
function setup()
{
    ...
    //createObject
    rectangleObject = new Rectangle(100, 200, 100, 115, 700, 140, 200);
    squareObject = new Square(360,500, 50, 900, 120, 100)
    ellipseObject = new Ellipse(420,120,150,90,90,90,80,80,9000)
